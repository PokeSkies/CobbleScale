...
import com.pokeskies.cobblescale.commands.BaseCommand
...
class CobbleScale : ModInitializer {
    companion object {
        lateinit var INSTANCE: CobbleScale

        var MOD_ID = "cobblescale"
        var MOD_NAME = "CobbleScale"
