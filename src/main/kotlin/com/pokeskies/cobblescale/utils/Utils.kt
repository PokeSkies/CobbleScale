...
object Utils {
    ...
    fun printDebug(message: String, bypassCheck: Boolean = false) {
        if (bypassCheck || ConfigManager.CONFIG.debug)
            CobbleScale.LOGGER.info("[${CobbleScale.MOD_NAME}] DEBUG: $message")
    }

    fun printError(message: String) {
        CobbleScale.LOGGER.error("[${CobbleScale.MOD_NAME}] ERROR: $message")
    }

    fun printInfo(message: String) {
        CobbleScale.LOGGER.info("[${CobbleScale.MOD_NAME}] $message")
    }
